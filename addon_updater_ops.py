...
updater.addon = "anim_sequence_io"
...
def register(bl_info):
    ...
    updater.repo = "anim-seq"
    
    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/kjorgecaballero/anim-seq/"
    ...
    # CONFIGURACIÓN CORREGIDA: Solo releases, no branches
    ...
    updater.include_branches = False  # Deshabilitado para usar solo releases
    ...
    updater.use_releases = True  # Usar releases de GitHub
